...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
	  ...
	  <label class="mr-3"> Não tem uma Conta?</label>
...
<div class="login-box">
<h1>LOGIN</h1>
<form class="form-signin" method="POST" action="http://localhost/pizzaria/logar.php">
<div class="textbox">
...
<input class="btn" type="submit" value="Logar" id="cadastrar" name="cadastrar">
